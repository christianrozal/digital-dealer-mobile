...
import { hideCustomersFilter, showCustomersFilter } from "@/store/uiSlice";
import { router } from "expo-router";
import { setSelectedCustomer } from "@/store/customerSlice"; // Import the action
...
const CustomersScreen = () => {
  ...
  return (
    <>
    {/* Add Icon */}
    <TouchableOpacity className="fixed bottom-20 right-5 z-10" onPress={() => router.push("/home/customers/add")}>
    <AddIcon />
  </TouchableOpacity>
    <ScrollView className="px-5 pt-20 pb-32">
      ...
      <View className="mt-5">
        ...
        {recentCustomers.map((customer) => (
          <TouchableOpacity
            ...
            onPress={() => {
              dispatch(setSelectedCustomer(customer)); // Dispatch action
                console.log("Customer selected in Customers Tab:", customer); // Log the data
